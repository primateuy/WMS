...
class SetuIntercompanyTransfer(models.Model):
    ...
    def _primate_channel_picking_type(self, role='fulfiller'):
        ...
        """
        self.ensure_one()
        canal = self._primate_get_channel()
        if not canal:
    ...
    def create_direct_picking(self):
        ...
        """
        picking_type = self._primate_channel_picking_type('fulfiller') or \
            self._primate_channel_picking_type('requestor')
        if not picking_type:
    ...
    def create_two_step_pickings(self):
        ...
        """
        tipo_origen = self._primate_channel_picking_type('fulfiller')
        tipo_destino = self._primate_channel_picking_type('requestor')
